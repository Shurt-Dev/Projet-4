...
LTexture gButton1SpriteSheetTexture;
LTexture gButton2SpriteSheetTexture;
LTexture gButton3SpriteSheetTexture;
...
void LButton::render()
{
	//Show current button sprite
		gButton1SpriteSheetTexture.render(mPosition.x, mPosition.y, &gSpriteClips[mCurrentSprite]);
}
...
bool loadMedia()
{
	...
	//Load sprites
	if (!gButton1SpriteSheetTexture.loadFromFile("C:/Users/eprevost/Downloads/button4.png") || !gButton2SpriteSheetTexture.loadFromFile("C:/Users/eprevost/Downloads/button5.png") || !gButton3SpriteSheetTexture.loadFromFile("C:/Users/eprevost/Downloads/button6.png"))
	{
...
{
	//Free loaded images
	gButton1SpriteSheetTexture.free();
	gButton2SpriteSheetTexture.free();
	gButton3SpriteSheetTexture.free();
